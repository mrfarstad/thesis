...
df = pd.DataFrame(
        {"version":versions, "GPUs":GPUs, "dimensions":dimensions, "BLOCK_X":blockx, "BLOCK_Y":blocky},
        columns=["version", "GPUs", "dimensions","BLOCK_X","BLOCK_Y"]
        )
